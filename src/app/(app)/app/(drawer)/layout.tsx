...
export default function DrawerLayout({
  ...
  React.useEffect(() => {
    if (isExpired && !pathname.includes("/blocked") && !pathname.includes("/plans")) {
      router.replace("/app/blocked/plans");
    }
          ...
          {isPastDue && (
            <Alert variant="destructive" className="bg-destructive/10 border-destructive/20">
              ...
              <div className="flex w-full items-center justify-between">
                ...
                <Button variant="destructive" size="sm" onClick={() => router.push("/app/blocked/plans")}>
                  Renew Now
                </Button>
              </div>
            </Alert>
          ...
          {isTrialing && (
            <Alert className="bg-primary/5 border-primary/20">
              ...
              <div className="flex w-full items-center justify-between">
                ...
                <Button size="sm" onClick={() => router.push("/app/blocked/plans")}>
                  Upgrade
                </Button>
              </div>
            </Alert>
